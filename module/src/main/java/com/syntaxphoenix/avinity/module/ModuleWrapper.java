...
public final class ModuleWrapper<M extends Module> {
    ...
    private ModuleException failedException;

    public ModuleWrapper(final ModuleManager<M> manager, final ModuleDescription description, final File file, final File dataLocation,
    ...
    final void setFailedException(final ModuleException failedException) {
    ...
    public boolean hasFailedException() {
        return failedException != null;
    }

    public ModuleException getFailedException() {
