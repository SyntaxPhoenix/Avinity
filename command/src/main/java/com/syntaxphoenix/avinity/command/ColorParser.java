...
public final class ColorParser {
    ...
    private static int parseHexTwiceThrow(String value) throws NumberFormatException {
        return parseHexThrow(value + value);
    }

    private static int parseHexTwice(String value) {
        return parseHex(value + value);
    }

    private static int parseHexThrow(String value) throws NumberFormatException {
